...
export default function ToastContainer() {
  ...
  const getToastStyles = (type: ToastMessage['type']) => {
    switch (type) {
      ...
      case 'error':
        return {
          bg: 'bg-rose-50 border-rose-100 dark:bg-rose-950/40 dark:border-rose-900/50',
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="shrink-0 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors rounded-lg p-0.5 mt-0.5"
                title="Fechar"
              >
                <X className="w-4 h-4" />
              </button>
